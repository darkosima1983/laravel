        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('product.edit', ['product' => $product->id]) }}" class="btn btn-sm btn-primary">Bearbeiten</a>
                        <a href="{{ route('product.delete',['product'=> $product->id]) }}" class="btn btn-sm btn-danger" onclick="return confirm('Sind Sie sicher, dass Sie dieses Produkt löschen möchten?')">Löschen</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
